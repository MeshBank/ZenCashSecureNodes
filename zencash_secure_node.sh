...
# adduser zuser && adduser zuser sudo

# From your local machine connect to the VM using zuser
# ssh zuser@znode1
#
...
# https://securenodes.<your_region>.zensystem.io/<you_node_t_address>/<nodeID>/send
